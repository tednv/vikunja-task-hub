...
No Home Assistant devices or entities are created. Projects, categories, tasks, and attachments remain Vikunja resources and are fetched when the card loads or completes an action.
